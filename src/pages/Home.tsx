        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="hidden lg:flex items-center space-x-4">
              {isLoggedIn ? (
                <>
                  ...
                  <div className="flex items-center space-x-2 px-4 py-2.5 bg-gradient-to-r from-purple-50 to-blue-50 rounded-lg border border-purple-100">
                    <div className={`w-8 h-8 rounded-full flex items-center justify-center text-white text-sm font-bold ${
                      userRole === 'ADMIN' ? 'bg-gradient-to-r from-red-600 to-pink-600' : 'bg-gradient-to-r from-purple-600 to-blue-600'
                    }`}>
                    ...
                    <div className="text-left">
                      ...
                      <div className="text-xs text-gray-600">
                        {userRole === 'ADMIN' ? 'ADMIN, UTILISATEUR' : 'UTILISATEUR'}
                      </div>
                    </div>
                  </div>

                  {/* =========================================== */}
                  {/* ⭐⭐⭐ BOUTONS COMPLETS POUR LE TABLEAU DE BORD ⭐⭐⭐ */}
                  {/* =========================================== */}
                  <div className="flex items-center space-x-2">
                    {/* 1. Tableau de bord */}
                    <Link to="/dashboard" className="px-4 py-2.5 bg-gradient-to-r from-purple-600 to-blue-600 text-white rounded-lg hover:from-purple-700 hover:to-blue-700 transition-all font-medium shadow-lg hover:shadow-xl flex items-center">
                    ...
                    <Link to="/dashboard/evenements" className="px-4 py-2.5 border-2 border-purple-600 text-purple-600 rounded-lg hover:bg-purple-50 transition-all font-medium flex items-center">
                      <svg className="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <Link to="/events" className="px-4 py-2.5 border-2 border-green-600 text-green-600 rounded-lg hover:bg-green-50 transition-all font-medium flex items-center">
                      <svg className="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    {/* 4. Annuler un événement */}
                    <button onClick={() => navigate('/dashboard/evenements')} className="px-4 py-2.5 border-2 border-red-600 text-red-600 rounded-lg hover:bg-red-50 transition-all font-medium flex items-center">
                      <svg className="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    {/* 5. Actualiser */}
                    <button onClick={handleRefresh} className="px-4 py-2.5 border-2 border-yellow-600 text-yellow-600 rounded-lg hover:bg-yellow-50 transition-all font-medium flex items-center">
                    ...
                    <Link to="/create-event" className="px-4 py-2.5 bg-gradient-to-r from-emerald-600 to-teal-600 text-white rounded-lg hover:from-emerald-700 hover:to-teal-700 transition-all font-medium shadow-lg hover:shadow-xl flex items-center">
                      <svg className="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    {/* 7. Déconnexion */}
                    <button onClick={handleLogout} className="px-4 py-2.5 bg-gradient-to-r from-red-600 to-pink-600 text-white rounded-lg hover:from-red-700 hover:to-pink-700 transition-all font-medium shadow-lg hover:shadow-xl flex items-center">
                      <svg className="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <>
                  <div className="flex items-center space-x-6">
                    <a href="#accueil" className="text-gray-700 hover:text-purple-600 font-medium transition-colors px-3 py-2">Accueil</a>
                  ...
                  <div className="flex items-center space-x-3">
                    <Link to="/login" className="px-5 py-2.5 border-2 border-purple-600 text-purple-600 rounded-lg hover:bg-purple-50 transition-all font-medium">Se connecter</Link>
                    <Link to="/register" className="px-5 py-2.5 bg-gradient-to-r from-purple-600 to-blue-600 text-white rounded-lg hover:from-purple-700 hover:to-blue-700 transition-all font-medium shadow-lg hover:shadow-xl">Inscription</Link>
                  </div>
                </>
              )}
            </div>
          ...
          {isLoggedIn && (
            <div className="lg:hidden border-t border-gray-200 pt-4 pb-4">
              <div className="mb-4 flex items-center px-3 py-2 bg-gradient-to-r from-purple-50 to-blue-50 rounded-lg border border-purple-100">
                ...
                <div className="ml-3 text-left">
                  <div className="text-sm font-semibold text-gray-900">{userEmail}</div>
                  <div className="text-xs text-gray-600">{userRole === 'ADMIN' ? 'ADMIN, UTILISATEUR' : 'UTILISATEUR'}</div>
                </div>
              </div>

              <div className="grid grid-cols-2 gap-3">
                {/* 1. Tableau de bord */}
                <Link to="/dashboard" className="px-4 py-3 bg-gradient-to-r from-purple-600 to-blue-600 text-white rounded-lg font-medium text-sm text-center flex items-center justify-center">
                  <svg className="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6" />
                  </svg>
                  Tableau de bord
                ...
                {/* 2. Voir les événements */}
                <Link to="/dashboard/evenements" className="px-4 py-3 border-2 border-purple-600 text-purple-600 rounded-lg font-medium text-sm text-center flex items-center justify-center">
                  <svg className="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
                  </svg>
                  Voir événements
                ...
                {/* 3. Inscription */}
                <Link to="/events" className="px-4 py-3 border-2 border-green-600 text-green-600 rounded-lg font-medium text-sm text-center flex items-center justify-center">
                  <svg className="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M18 9v3m0 0v3m0-3h3m-3 0h-3m-2-5a4 4 0 11-8 0 4 4 0 018 0zM3 20a6 6 0 0112 0v1H3v-1z" />
                  </svg>
                  Inscription
                ...
                {/* 4. Annuler événement */}
                <button onClick={() => navigate('/dashboard/evenements')} className="px-4 py-3 border-2 border-red-600 text-red-600 rounded-lg font-medium text-sm text-center flex items-center justify-center">
                  <svg className="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M6 18L18 6M6 6l12 12" />
                  </svg>
                  Annuler événement
                ...
                {/* 5. Actualiser */}
                <button onClick={handleRefresh} className="px-4 py-3 border-2 border-yellow-600 text-yellow-600 rounded-lg font-medium text-sm text-center flex items-center justify-center">
                  <svg className="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15" />
                  </svg>
                  Actualiser
                ...
                {/* 6. Créer événement */}
                <Link to="/create-event" className="px-4 py-3 bg-gradient-to-r from-emerald-600 to-teal-600 text-white rounded-lg font-medium text-sm text-center flex items-center justify-center">
                  <svg className="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 4v16m8-8H4" />
                  </svg>
                  Créer événement
                ...
                {/* 7. Déconnexion */}
                <button onClick={handleLogout} className="px-4 py-3 bg-gradient-to-r from-red-600 to-pink-600 text-white rounded-lg font-medium text-sm text-center flex items-center justify-center col-span-2">
                  <svg className="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 16l4-4m0 0l-4-4m4 4H7m6 4v1a3 3 0 01-3 3H6a3 3 0 01-3-3V7a3 3 0 013-3h4a3 3 0 013 3v1" />
                  </svg>
                  Déconnexion
          ...
          {/* Mobile menu - Version non connectée */}
          {!isLoggedIn && (
            <div className="lg:hidden border-t border-gray-200 pt-4 pb-4">
              <div className="flex flex-col space-y-3">
                ...
                <div className="grid grid-cols-2 gap-3 pt-2">
                  <Link to="/login" className="px-4 py-3 border-2 border-purple-600 text-purple-600 rounded-lg font-medium text-sm text-center">Se connecter</Link>
                  <Link to="/register" className="px-4 py-3 bg-gradient-to-r from-purple-600 to-blue-600 text-white rounded-lg font-medium text-sm text-center">Inscription</Link>
                </div>
              </div>
            </div>
          )}
          ...
          <div className="grid md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-400">
                ...
                <li><Link to="/create-event" className="hover:text-white transition-colors">Créer un événement</Link></li>
                <li><Link to="/dashboard" className="hover:text-white transition-colors">Gestion événements</Link></li>
